...
echo ""
echo "Next steps:"
echo "  1. Point vibesvault.live DNS (CNAME) to: $LB_HOST"
echo "  2. Deploy all services via GitHub Actions"
echo "  3. Configure Razorpay webhook URL: https://vibesvault.live/payments/webhook/razorpay"
echo "  4. Test: curl https://vibesvault.live/auth/signup"
